...
public class TestModelMaker implements IModelMaker {
    ...
    public RendererModel getModelRendererForBlockState(PartDefinition partDefinition, BlockState blockState, IBakedModel model, String partName) {
        return new RendererModel(new SheepWoolModel<>(), 0, 0);
    }
}
