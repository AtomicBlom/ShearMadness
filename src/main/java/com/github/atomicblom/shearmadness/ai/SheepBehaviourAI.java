...
public class SheepBehaviourAI extends Goal
{
    private final SheepEntity entity;
    private LazyOptional<IChiseledSheepCapability> capability;
    ...
    public SheepBehaviourAI(LivingEntity entity)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        return this.capability.map(capability -> {
    ...
    private static class ActiveBehaviour {
