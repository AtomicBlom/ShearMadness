...
public interface IVariationRegistry
{
     ...
     * @param handlesVariant a function that should return true if your IModelMaker applies to the itemStack
     * @param variationModelMaker the transforms for the model
     */
    void registerVariation(Function<ItemStack, Boolean> handlesVariant, QuadrupedTransformDefinition variationModelMaker);
}
